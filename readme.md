...
<h2 align="center">
<img alt="layout demonstrativo" src="static/img/lyout projeto instagram.png" width="600px">
</h2>
...
```bash
        git clone https://github.com/stanislawiaw2018/project-instram-Digital-Innovation-One.git
